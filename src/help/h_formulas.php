...
<blockquote>count(confidence=X)</blockquote>";
        ...
        echo $hth->trow("<em>e1</em> &amp;&amp; <em>e2</em>", "Logical and (returns <em>e1</em> if <em>e1</em> is falsy, otherwise returns <em>e2</em>)");
        echo $hth->trow("<em>e1</em> || <em>e2</em>", "Logical or (returns <em>e1</em> if <em>e1</em> is truthy, otherwise returns <em>e2</em>)");
        echo $hth->trow("<em>test</em> ? <em>iftrue</em> : <em>iffalse</em>", "If-then-else operator");
        echo $hth->trow("isnull(<em>e</em>)", "Return true if <em>e</em> is null");
...
Use an aggregate function to calculate a property over all review scores.</p>";
        ...
        echo $hth->trow("any(<em>e</em>)", "True if <em>e</em> is truthy for any review");
        echo $hth->trow("all(<em>e</em>)", "True if <em>e</em> is truthy for all reviews");
