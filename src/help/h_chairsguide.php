...
form also can include:</p>
  ...
  " and set their preferences on the ", $hth->hotlink("application applications", "paper"), ".</p>
  ...
  such conflicts.</p></li>\n";
            ...
            echo "<li><p><strong>", $hth->hotlink("Assign reviews.", "manualassign"), "</strong> You can make assignments ", $hth->hotlink("by application", "assign"), ", ",
