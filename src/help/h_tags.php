...
default tag value is 0: #t#0 displays as #t. You can search for
...
to adjacent application.  The gaps make it harder to infer
...
with colors so that, for example, applications tagged #reject appear as
gray.</p>\n";
    }
...
high-ranked application, but it’s usually better to trust the PC.)</p>\n";
 ...
 A ", $this->hth->hotlink("search", "search", ["t" => "s", "q" => "-#pcpaper"]), " shows applications without PC authors.</p>\n";
    }
...
" &gt; Decide to mark the final decisions. (Or just use the per-application decision selectors.)</p>\n";
    }
}
